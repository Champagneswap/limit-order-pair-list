...
(async () => {
  try {
    ...
    for (const key of Object.keys(ChainId)) {
      ...
      // Grab file file names of the champagneswap/icons repo at the token path
      ...
      for (const token of tokens) {
        ...
        if (!token.logoURI.includes("champagneswap/icons")) {
          // TODO: Automate this part...
          const logoURI = `https://raw.githubusercontent.com/champagneswap/icons/master/token/${icon}.jpg`;
